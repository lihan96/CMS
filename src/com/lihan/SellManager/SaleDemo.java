...
public class SaleDemo extends JPanel {
    ...
    SaleDemo() {
        ...
        this.setLayout(null);
        JLabel title = new JLabel("销售单添加");
        title.setBounds(10, 10, 270, 80);
        title.setForeground(new Color(0, 152, 210));
        title.setFont(new Font("新宋体", java.awt.Font.PLAIN, 32));
        this.add(title);

        JLabel[] jLabels = {new JLabel("* 销售编号"), new JLabel("* 客户编号:"),
                new JLabel("* 商品编号:"), new JLabel("* 销售时间:"), new JLabel("* 数    量:")};
        JLabel info = new JLabel("请输入商品信息：");
        ...
        btnAdd.addActionListener(e -> {
            ...
            try {
                ...
                String sql = "INSERT INTO tb_sale(sal_id,cus_id,pro_id,date,number)" +
